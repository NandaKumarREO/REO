...
//boolean headless
	public void startAppMob(String browser,boolean headless, String url) {
		try {
			if (browser.equalsIgnoreCase("chrome")) {
	//			System.setProperty("webdriver.chrome.silentOutput", "true");
				setDriverMob("chrome", headless, url);
			} 
//			else if (browser.equalsIgnoreCase("firefox")) {
//				setDriverMob("firefox", headless);
//			} else if (browser.equalsIgnoreCase("ie")) {
//				setDriverMob("ie", headless);
//			} else if (browser.equalsIgnoreCase("edge")) {
//				setDriverMob("edge", headless);
//			}
...
//			driver.get(url);
			 ...
			 * xpath("//section[@class='position-relative bg-dark py-2 opacify-links text-white region region-top-bar']/div[1]/div/a[2]/span"
			 * ))); reportStep("Home Page Menu link click", "pass"); Thread.sleep(3000);
			 * executor.executeScript("arguments[0].click()",
			 * driver.findElement(By.xpath("//nav[@id='block-useraccountmenu']/ul/li/a")));
			 * reportStep("Login button Click", "pass"); Thread.sleep(1000); WebElement
			 * eleUsername = locateElement(Locators.NAME, "name");
			 * eleUsername.sendKeys("nanda.kumar@reodigital.com");
			 * reportStep(" username is entered successfully", "pass"); Thread.sleep(1000);
			 * WebElement elePassword = locateElement(Locators.ID, "edit-pass");
			 * elePassword.sendKeys("Testing@123!");
			 * reportStep(" password is entered successfully", "pass"); //TestEnd
			 */
